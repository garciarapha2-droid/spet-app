      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <ChartCard title="New vs Lost Customers" subtitle="Monthly acquisition vs churn">
          ...
          <div className="flex items-center justify-center gap-6 mt-2 pt-2 border-t border-border/50">
            <span className="flex items-center gap-1.5 text-[10px] text-muted-foreground font-medium"><span className="w-2.5 h-2.5 rounded-sm bg-emerald-500" />New</span>
            <span className="flex items-center gap-1.5 text-[10px] text-muted-foreground font-medium"><span className="w-2.5 h-2.5 rounded-sm bg-red-500" />Lost</span>
          </div>
        </ChartCard>
      </div>
