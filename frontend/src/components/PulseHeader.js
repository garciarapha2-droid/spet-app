...
export const PulseHeader = () => {
  ...
  return (
    <header className="h-14 border-b border-border/60 bg-card/80 backdrop-blur-md px-6 flex items-center justify-between relative z-50" data-testid="pulse-header">
