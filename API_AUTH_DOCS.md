...
# Base URL: https://dark-light-theme-5.preview.emergentagent.com
...
```
https://dark-light-theme-5.preview.emergentagent.com/auth/handoff?token=<JWT>
```

**Lovable code example:**
```javascript
// After successful login
const res = await fetch("https://dark-light-theme-5.preview.emergentagent.com/api/auth/login", {
  method: "POST",
...
window.location.href = `https://dark-light-theme-5.preview.emergentagent.com/auth/handoff?token=${data.access_token}`;
```
...
```javascript
// Step 1: Login
const loginRes = await fetch("https://dark-light-theme-5.preview.emergentagent.com/api/auth/login", {
  method: "POST",
  headers: { "Content-Type": "application/json" },
  body: JSON.stringify({ email, password }),
});
...
const handoffRes = await fetch("https://dark-light-theme-5.preview.emergentagent.com/api/auth/handoff/create", {
  method: "POST",
...
window.location.href = `https://dark-light-theme-5.preview.emergentagent.com/auth/handoff?code=${code}`;
```
...
| Purpose           | URL                                                                    |
|-------------------|------------------------------------------------------------------------|
| API base          | `https://dark-light-theme-5.preview.emergentagent.com/api`               |
| App (frontend)    | `https://dark-light-theme-5.preview.emergentagent.com`                   |
| Token handoff     | `https://dark-light-theme-5.preview.emergentagent.com/auth/handoff?token=<JWT>` |
| Code handoff      | `https://dark-light-theme-5.preview.emergentagent.com/auth/handoff?code=<CODE>` |
| Dashboard         | `https://dark-light-theme-5.preview.emergentagent.com/venue/home`        |
