...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://rbac-foundation-1.preview.emergentagent.com')
...
class TestOnboardingCheckoutAPI:
    ...
    def test_checkout_creates_session(self, api_client):
        ...
        checkout_payload = {
            "plan_id": "growth",
            "lead_id": lead_id,
            "origin_url": "https://rbac-foundation-1.preview.emergentagent.com"
        }
